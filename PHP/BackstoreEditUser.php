...
//read the file and find the correct line of data from the checkbox and store the information in an array for display
            ...
            fclose($myfile);
                    ...
                    //     $UserNumber = $_REQUEST["index"];
                    //     echo "<form name='editForm' id='formOrderEdit' class='orderFrom' action='edit.php?index=$UserNumber' method='POST'>";
                    
                    //   $myfile = fopen("../Data/users.txt", "r") or die("Unable to open file!");
                    //   $UserList = array();
                    //   $lineNumber = 1;
                    //   echo"THe order is: $UserNumber";
                    //   while(!feof($myfile)) {
                    //       $line = fgets($myfile);  
                    //       $lineArray = explode(" ", $line);

                    //       echo"$lineArray";
                    //       if ($UserNumber == $lineNumber){
                    //           $elements = $lineArray;
                    //           break;
                    //       }
                    //       if($UserNumber == -1){
                ...
                //        <input type = \"button\" value = \"Cancel\" onclick=\"resetForm()\" class=\"btn btn-secondary\" style=\"float:right; margin-right: 5px;\"/>
                ...
                //           <label><input type=\"radio\" name=\"gender\" style=\"margin: 0 10px 0 2px;\" value=\"Female\"\>";
                //           if(strcmp($gender, "Female") == 0){
                //               echo "checked";
                //           }
                //          echo" />Female</label> ";
                //          echo "<label><input type=\"radio\" name=\"gender\" style=\"margin: 0 10px 0 2px;\" value=\"Male\"";
                ...
                //       <input type=\"text\" name=\"postal\" id=\"postCode\" value=\"$postal\" class=\"form-control\">
                //     </div>
                //   </div>
